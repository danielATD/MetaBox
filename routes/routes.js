...
router.post("/register", check('name').notEmpty().withMessage('Debes ingresar un nombre.'),check('lastname').notEmpty().withMessage('Debes ingresar un apellido.'),check('email').isEmail().withMessage('Ingresa un correo válido.'),
